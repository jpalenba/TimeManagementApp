...
namespace TimeManagementApp.Forms
{
    public partial class CalendarForm : BaseForm
    {
        ...
        public CalendarForm()
        {
            KeyPreview = true;               // capture key events
            InitializeComponent();
            ...
            // ask user to load existing or start new
        ...
        {
            Text        = "Weekly Schedule";    // window title
            ...
            // right-click menu to clear cells
        ...
        private void InitializeScheduleGrid()
        {
            ...
            // first column fixed width, others fill
            ...
            // add hourly rows from 6am to midnight
        ...
        private void LoadSchedule()
        {
            ...
            TaskRepository.Load();    // load tasks.json
        }
        ...
        private void SaveSchedule()
        {
            ...
            for (int r = 0; r < scheduleGrid.Rows.Count; r++)
            {
                for (int c = 1; c < scheduleGrid.Columns.Count; c++)
                {
                    ...
                    var cat   = Categories.Contains(parts[0]) ? parts[0] : "Personal";
        ...
        {
            // export grid as CSV via SaveFileDialog
        ...
        private void ScheduleGrid_CellDoubleClick(object? sender, DataGridViewCellEventArgs e)
        {
            ...
            txtDesc.Text = existing.Contains(": ") ? existing.Split(new[] { ": " }, 2, StringSplitOptions.None)[1] : existing;
            ...
            var exCat = existing.Contains(": ") ? existing.Split(new[] { ": " }, 2, StringSplitOptions.None)[0] : Categories[0];
        ...
        {
            // show clear menu on right-click
        ...
        private void AdjustRowHeights()
        {
            ...
            // distribute available height evenly
        ...
        {
            // add or remove task based on cell text
